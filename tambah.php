...
<!-- tag dihilangkan-->
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      <h1 class="text-center mt-4">Form pendaftaran pasien</h1>
      <form method="POST">
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="inputtanggal" name="tanggal" placeholder="Masukan tanggal lahir pasien">
                  </div>
                  <div class="mb-3">

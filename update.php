  ...
  <form method="POST">
    ...
    <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="inputtanggal" name="tanggal" placeholder="Masukan agama pasien">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="inputNama" class="form-label">diagnosa</label>
...
if(isset($_POST['daftar'])){
  ...
  // Membuat Query
  $query = "UPDATE tb_siswa SET nama = '$nama', tanggal = '$tanggal', ruang = '$ruang', telepon = '$telepon', diagnosa = '$diagnosa', alamat = '$diagnosa' WHERE id = '$id'";
